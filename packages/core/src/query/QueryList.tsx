...
export type IQueryListOptions<Variables extends IVariables = IVariables> =
	IQueryOptions<IListVariables<Variables>>;
...
export type IUseQueryListResult<Data extends IData = IData> = IUseQueryResult<
	IListData<Data>
>;
...
>(options: IUseQueryListOptions<Data, Variables>): IUseQueryListResult<Data> {
