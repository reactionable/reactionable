...
import type { IUseModalFormProps } from "../../ui/modal/useModalForm";
...
> =
	| Omit<
			IUseModalFormProps<Values, Data, FormButtonProps, ModalProps>,
			"form" | "title"
	  >
	| true;
...
>): ReactElement {
	...
	return (
		<>
			<EnhanceChildren enhance={{ onClick: openModal }}>
				{children}
			</EnhanceChildren>
			{modal}
		</>
