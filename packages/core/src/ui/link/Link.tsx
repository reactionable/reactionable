...
// biome-ignore lint: link refs must stay generic across UI integrations.
export type LinkForwardedRef = ForwardedRef<any>;

export type ILinkComponentProps = Omit<ILinkProps, "Component"> & {
	ref?: LinkForwardedRef;
};
...
export type ILinkProps = PropsWithChildren<{
	href?: string;
	title?: string;
	// biome-ignore lint: click handlers are intentionally generic across link implementations.
