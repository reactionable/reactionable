...
export type IUseWarningAlert<
	UseWarningAlertProps extends IUseWarningAlertProps,
> = (props?: UseWarningAlertProps) => IUseWarningAlertResult;
...
>(
	...
	const { alert: warningAlert, setAlert: setWarningAlert } = useAlert({
		Component,
		...props,
	});
