...
export type INotificationComponent = ComponentType<
...
> = PropsWithChildren<
	NotificationProps & { Component?: INotificationComponent }
>;
...
export function useNotification<P extends IUseNotificationProps>({
	...
	const [notification, setNotification] = useState<ReactNode | undefined>(
		undefined,
	);
