...
export type IAccountLinkProps<LinkProps extends ILinkProps> =
	IWithNavItemComponentProps<LinkProps>;
...
export type ILogoutLinkProps<LinkProps extends ILinkProps> =
	IWithNavItemComponentProps<LinkProps>;
...
export function UserUnloggedHeaderNav<
	LinkProps extends ILinkProps = ILinkProps,
>({
	NavItemComponent = NavItem,
	...
	const { modal, openModal } = useModal({
		title: t(
			keyFromSelector(($) => $["Sign In / Sign Up"], { ns: "identity" }),
		),
		body: <AuthComponent />,
	});
	...
	const linkComponentProps = {
		...
		// biome-ignore lint: the click handler intentionally ignores the DOM event payload.
