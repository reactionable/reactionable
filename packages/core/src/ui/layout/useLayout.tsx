...
import { type ILayoutProps, Layout, type LayoutComponent } from "./Layout";

export type IUseLayoutProps<LayoutProps extends ILayoutProps = ILayoutProps> =
	PropsWithChildren<LayoutProps & { Component?: LayoutComponent<LayoutProps> }>;
