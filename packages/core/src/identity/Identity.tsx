...
import type { IUseQueryResult } from "../query/Query";
...
export type IIdentityProviderProps<User extends IUser = IUser> =
	IProviderProps<{
...
const { Context: IdentityContext, useContext } =
	createProvider<IIdentityProviderValue>({
...
function IdentityContextProvider<User extends IUser>({
	...
	return (
		<IdentityContext.Provider
			value={providerValues as IIdentityProviderValue<IUser>}
		>
			{loader}
			{errorNotification}
			{errorAlert}
...
export function withIdentityContext<User extends IUser>(
	...
	return (
		<IdentityContextProvider
			{...useIdentityProviderProps(identityProviderProps)}
		>
			<Component />
		</IdentityContextProvider>
	);
