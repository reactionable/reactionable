...
export type NavItemType<C extends INavItemsProps<INavItemProps>> =
	C extends INavItemsProps<infer N>
		? N extends INavItemProps
			? N
			: INavItemProps
		: INavItemProps;

export function useNavItemsProviderProps<
	NavItemsProps extends INavItemsProps<INavItemProps>,
>(
	props?: Partial<INavItemsProviderProps<NavItemsProps>>,
): INavItemsProviderProps<NavItemsProps> {
	const [navItems, internalSetNavItems] = useState<
		NavItemType<NavItemsProps>[]
