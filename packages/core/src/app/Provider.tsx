...
type IProviderComponent<
	ExtraProps extends IProviderExtraProps = IProviderExtraProps,
...
export function createProvider<
	ProviderProps extends IProviderProps = IProviderProps,
>(props: ProviderProps): ICreateProviderResult<ProviderProps> {
	...
	const ContextProvider = ({
		...
		return (
			<CreatedContext.Provider value={props as ProviderProps}>
				{children}
