import {
	...
	type INavItemsProviderProps as ICoreNavItemsProviderProps,
	type ISidebarProps as ICoreSidebarProps,
	type INavItemsProps,
	keyFromSelector,
	useTranslation,
...
import { type INavItemProps, NavItems } from "../../nav/NavItem";

export type INavItemsProviderProps = ICoreNavItemsProviderProps<
	INavItemsProps<INavItemProps>
>;
				...
				>
					{!open && (
						<Button
							...
							aria-controls={t(
								keyFromSelector(($) => $["Collapse sidebar"], { ns: "common" }),
							)}
							aria-expanded={open}
						>
							{t(
