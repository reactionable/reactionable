...
import { type IUseModalProps, Modal, useModal } from "./Modal";
import { ModalForm } from "./ModalForm";
import { type IUseModalFormProps, useModalForm } from "./useModalForm";
...
export const UseModalFormHook: StoryObj<
	IUseModalFormProps<IFormValues, IFormData>
> = {
	args: {
		onHide: action("Modal closed"),
