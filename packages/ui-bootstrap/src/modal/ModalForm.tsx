...
export type IModalFormComponentProps<Values, Data> = ICoreModalFormComponentProps<IFormProps<Values, Data>> & {
    submitButton?: string;
    cancelButton?: string;
};

export function ModalForm<Values, Data>({ submitButton, cancelButton, closeModal,children, ...formProps }: PropsWithChildren<IModalFormComponentProps<Values, Data>>) {
