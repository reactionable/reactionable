...
>({
	...
	if (typeof children === "function") {
		...
		const fieldProps: IFormFieldPropsEnhanced<
			FieldElementProps,
			Value
		>["field"] = {
			...field,
		...
		switch (true) {
			...
			case field.as === "select":
				fieldContent = (
					<RenderFormFieldSelect field={fieldProps} labelId={inputLabelId} />
				);
				break;

			case field.as === "textarea":
				fieldContent = (
					<RenderFormFieldTextarea field={fieldProps} labelId={inputLabelId} />
				);
				break;
