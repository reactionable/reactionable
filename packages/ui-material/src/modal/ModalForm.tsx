...
import {
	...
	FormFields,
	type IModalFormProps as ICoreModalFormProps,
	type IFormData,
...
>({
	...
	const cancel = useFormButton({
		children:
			cancelButton ?? t(keyFromSelector(($) => $.Cancel, { ns: "common" })),
		disabled: formikProps.isSubmitting,
		onClick: closeModal,
		color: "secondary",
		fullWidth: false,
...
>({
	...
	const formChildren: IFormWrapperProps<Values, FormButtonProps>["children"] = (
		formikProps,
	) => (
	...
	return (
		<CoreModalForm<Values, Data, FormButtonProps>
			{...props}
			submitButton={false}
		>
			{formChildren}
