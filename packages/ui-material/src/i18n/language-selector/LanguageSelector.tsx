...
import {
	...
	type ILanguageSelectorComponentProps as ICoreLanguageSelectorComponentProps,
	type ILanguageSelectorItemComponentProps as ICoreLanguageSelectorItemComponentProps,
	type ILanguageSelectorProps as ICoreLanguageSelectorProps,
...
export type ILanguageSelectorItemComponentProps =
	ICoreLanguageSelectorItemComponentProps<ComponentProps<typeof MenuItem>>;
...
export type LanguageSelectorComponent =
	ComponentType<ILanguageSelectorComponentProps>;
...
export type ILanguageSelectorProps = Omit<
	ICoreLanguageSelectorProps,
	"Component"
> &
	ComponentProps<typeof Button>;
export function LanguageSelector(props: ILanguageSelectorProps): ReactElement {
	return (
		<CoreLanguageSelector Component={LanguageSelectorComponent} {...props} />
	);
}
